...
def weapons_input():
    ...
    global user_weapon_number      #用户的武器的精炼度2
    ...
    user_weapon = int(input('请选择你的武器:'))
    assert 1 <= user_weapon <= 8, '武器输入错误！'

    user_weapon_number = int(input('请输入武器精炼度:'))
    assert 1 <= user_weapon <= 5, '武器精炼度输入错误！'


    print('该武器为：' + str(weapons_list[user_weapon]))
    if  user_weapon == 1:
        bai_attck = 542
    ...
    weapon_All_hurt_on = All_hurt_on[user_weapon_number]
    weapon_All_hurt_off = All_hurt_off[user_weapon_number]
    weapon_attck_on = attck_on[user_weapon_number]
    weapon_attck_off = attck_off[user_weapon_number]
    weapon_defend_on = defend_on[user_weapon_number]
    weapon_defend_off = defend_off[user_weapon_number]
    weapon_Special_effects = Special_effects[user_weapon_number]
    weapon_Firm_but_gentle = Firm_but_gentle[user_weapon_number]
    weapon_bai_attck = bai_attck

if __name__=='__main__':
    weapons_input()
    print(str(weapons_list[user_weapon] + '的吃满被动的全伤为：' + str(weapon_All_hurt_on)))
    print(str(weapons_list[user_weapon] + '的无被动的全伤为：' + str(weapon_All_hurt_off)))
    print(str(weapons_list[user_weapon] + '的吃满被动的加的攻击为：' + str(weapon_attck_on)))
    print(str(weapons_list[user_weapon] + '的无被动的加的攻击为：' + str(weapon_attck_off)))
    print(str(weapons_list[user_weapon] + '的吃满被动的加的防御为：' + str(weapon_defend_on)))
    print(str(weapons_list[user_weapon] + '的无被动的加的防御为：' + str(weapon_defend_off)))
    print(str(weapons_list[user_weapon] + '的特效防御加伤为：' + str(weapon_Special_effects)))
    print(str(weapons_list[user_weapon] + '的刀波为：' + str(weapon_Firm_but_gentle)))
    print(str(weapons_list[user_weapon] + '的白值为：' + str(weapon_bai_attck)))
